...
The system runs as an [MCP server](https://modelcontextprotocol.io/) on Fly.io with a Supabase PostgreSQL backend. There is no GUI - you interact with your data entirely through AI assistants like Claude.
